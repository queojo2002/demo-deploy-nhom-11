...
if (isset($_GET['txtSearch']))
{
	...
	$result = mysqli_query($conn, "select count(MaDV) as total from donvi Where TenDV like '%$txtSearch%'");
}else {
	$result = mysqli_query($conn, 'select count(MaDV) as total from donvi');
}
