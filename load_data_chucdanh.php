...
if (isset($_GET['txtSearch']))
{
	...
	$result = mysqli_query($conn, "select count(MaCD) as total from chucdanh Where TenCD like '%$txtSearch%'");
}else {
	$result = mysqli_query($conn, 'select count(MaCD) as total from chucdanh');
}
