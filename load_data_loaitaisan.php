...
if (isset($_GET['txtSearch']))
{
	...
	$result = mysqli_query($conn, "select count(MaLTS) as total from loaitaisan Where TenLTS like '%$txtSearch%'");
}else {
	$result = mysqli_query($conn, 'select count(MaLTS) as total from loaitaisan');
}
