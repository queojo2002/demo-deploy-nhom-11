...
if (isset($_GET['txtSearch']))
{
	...
	$result = mysqli_query($conn, "select count(MaNTS) as total from nhomtaisan Where TenNTS like '%$txtSearch%'");
}else {
	$result = mysqli_query($conn, 'select count(MaNTS) as total from nhomtaisan');
}
